...
public class LearnTreeMap {
	public static void main(String[] args) {
		Map<String, Student1> set = new TreeMap<String, Student1>();
		//Set<Student1> set = new TreeSet<Student1>((o1,o2)-> o1.getAge() - o2.getAge());
		set.put("A",new Student1("HashSet8", 21, 97.00));
		set.put("C",new Student1("HashSet7", 21, 97.00));
		set.put("D",new Student1("HashSet5", 20, 98.00));
